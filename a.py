...
def main():
    ...
    resultado_prediccion = predecir_con_modelo(paciente)

    # Mostrar el resultado de la predicción
    st.write("Resultado de la Predicción:", resultado_prediccion)

def predecir_con_modelo(paciente):
    # URL del modelo en GitHub
    url_modelo = "https://raw.githubusercontent.com/fedraameneiro/DataScientistFinalProject/main/Proyecto_final_Ciencia_de_Datos_FedraAmeneiro_api.ipynb"
    ...
    if response.status_code == 200:
        ...
        resultado_prediccion = modelo.predict([paciente])
